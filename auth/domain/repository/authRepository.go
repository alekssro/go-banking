...
type AuthRepository interface {
	FindBy(username string, password string) (*entity.Login, *errs.AppError)
	GenerateAndSaveRefreshTokenToStore(authToken entity.AuthToken) (string, *errs.AppError)
...
func (d AuthRepositoryDb) GenerateAndSaveRefreshTokenToStore(authToken entity.AuthToken) (string, *errs.AppError) {
...
func (d AuthRepositoryDb) FindBy(username, password string) (*entity.Login, *errs.AppError) {
